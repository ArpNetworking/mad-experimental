...
public final class TestBeanFactory {
    ...
    /**
     * Create a builder for pseudo-random {@code Record}.
     *
     * @return New builder for pseudo-random {@code Record}.
     */
    ...
    /**
     * Create a new reasonable pseudo-random {@code Record}.
     *
     * @return New reasonable pseudo-random {@code Record}.
     */
    ...
    /**
     * Create a builder for pseudo-random {@code Metric}.
     *
     * @return New builder for pseudo-random {@code Metric}.
     */
    ...
    /**
     * Create a new reasonable pseudo-random {@code Metric}.
     *
     * @return New reasonable pseudo-random {@code Metric}.
     */
    ...
    /**
     * Create a builder for pseudo-random {@code AggregatedData}.
     *
     * @return New builder for pseudo-random {@code AggregatedData}.
     */
    ...
    /**
     * Create a new reasonable pseudo-random {@code AggregatedData}.
     *
     * @return New reasonable pseudo-random {@code AggregatedData}.
     */
    ...
    /**
     * Create a builder for pseudo-random {@code PeriodicData}.
     *
     * @return New builder for pseudo-random {@code PeriodicData}.
     */
    ...
    /**
     * Create a new reasonable pseudo-random {@code PeriodicData}.
     *
     * @return New reasonable pseudo-random {@code PeriodicData}.
     */
    ...
    /**
     * Create a builder for reasonable pseudo-random {@code Quantity}.
     *
     * @return New builder for reasonable pseudo-random {@code Quantity}.
     */
    ...
    /**
     * Create a new reasonable pseudo-random {@code Quantity}.
     *
     * @return New reasonable pseudo-random {@code Quantity}.
     */
    ...
    /**
     * Create a {@code List} of {@code Quantity} instances in
     * {@code Unit.MILLISECOND} from a {@code List} of {@code Double}
     * values.
     *
     * @param values The values.
     * @return {@code List} of {@code Quantity} instances.
     */
