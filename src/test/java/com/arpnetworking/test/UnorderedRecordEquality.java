...
/**
 * Implementation of {@code Comparator} which compares {@code Record}
...
public final class UnorderedRecordEquality {
    ...
    /**
     * Compare two {@code Record} instances ignoring the ordering of the
     * values in each metric.
     *
     * @param r1 First {@code Record} instance.
     * @param r2 Second {@code Record} instance.
     * @return True if and only if {@code Record} instances are equal
